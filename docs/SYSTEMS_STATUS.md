...
|--------|-------------|-----|-------|
| Live Game Center | 72 | LIVE_GAME_CENTER.md | **P1** — game-night browser test pending |
| Home Dashboard | 82 | PAGES.md | **P2** — hero-first paint; tune slow sections via perf footer |
